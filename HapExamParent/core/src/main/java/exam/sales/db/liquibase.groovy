//package exam.sales.db

import com.hand.hap.liquibase.MigrationHelper

//表结构
databaseChangeLog(logicalFilePath: "exam/sales/db/liquibase.groovy") {
    ...
    migrationHelper.dbmigrate("mysql",["com/hand/hap","exam/sales"] ,["table", "data"])
